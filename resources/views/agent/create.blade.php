        ...
        <div class="card-body">
            <form action="{{ route('agents.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <x-input-field :name="__('rate_of_interest')" :label="__('Rate Of Interest')" type="number" class="col-md-4" />
                    <x-input-field :name="__('discount_per_bag')" :label="__('Discount Per Bag')" type="number" class="col-md-4" />
                </div>
                ...
                <x-textarea :name="__('address')" :label="__('Agent Address')" />
